...
public class LoginSupplierJPanel extends javax.swing.JPanel {
    ...
    private void goJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_goJButtonActionPerformed
        ...
        Supplier supplier = (Supplier) pharmaListJComboBox.getSelectedItem();
        ViewSupplierCompany viewPharmacy = new ViewSupplierCompany(userProcessContainer,supplier);
